...
CKEDITOR.editorConfig = function( config ) {
    ...
    config.toolbar_SimpleUser = [
      { items: [ 'Bold', 'Italic', 'Underline', 'TextColor', '-', 'RemoveFormat', 'PasteText', '-', 'NumberedList', 'BulletedList', '-', 'Link', 'Unlink', 'uploadpictures', 'CodeSnippet', '-', ] }
  ];
